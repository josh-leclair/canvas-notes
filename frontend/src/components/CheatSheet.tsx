...
const GESTURES: [string, string][] = [
  ...
  ["Right-click a card", "Open its full actions menu at the pointer"],
  ...
  ["Right-click empty space", "Choose any card type or canvas object to create there"],
  ...
  ["Right-click a link", "Open its link details"],
